  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#0B0D14' }}>
      <div className="relative z-10">
        <button
          onClick={() => router.push('/')}
          className="fixed top-4 left-4 text-gray-400 hover:text-white transition-colors duration-300 flex items-center gap-2 z-20"
        >
          <ArrowLeft size={20} />
          <span>Volver</span>
        </button>
        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          ...
          >
            <div className="bg-gray-900/80 backdrop-blur-lg rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-800">
              {/* Header */}
              <h1 
              ...
              <p className="text-gray-400 italic mb-8 text-center text-sm sm:text-base">
              ...
              <section className="mb-12">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 text-sm sm:text-base">
                      <li>Contactarte y responder a tus solicitudes de servicios.</li>
                      <li>Proporcionar cotizaciones y diagnósticos de automatización.</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 text-sm sm:text-base">
                      ...
                      <li>Integraciones seguras con herramientas como Airtable para gestión de leads.</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 text-sm sm:text-base">
                      ...
                      <li>Oponerte al tratamiento, no estás obligado después del diagnóstico.</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 text-sm sm:text-base">
                      ...
                      <li>Provide quotes and automation diagnostics.</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 text-sm sm:text-base">
                      ...
                      <li>Secure integrations with tools like Airtable for lead management.</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4 text-sm sm:text-base">
                      ...
                      <li>Object to processing, you are not obligated after diagnosis.</li>
                    </ul>
                  </div>
                </div>
              ...
              <p className="text-gray-400 text-xs sm:text-sm text-center flex items-center justify-center gap-2">
